    ...
    <>
      ...
      <main className="mx-auto max-w-6xl px-6 py-14 md:py-20">
        <div className="hero-reveal">
          ...
          <h1 className="mt-4 max-w-2xl text-4xl tracking-tight md:text-5xl">
            <span className="serif-heading">Describe the job.</span>
            <span className="serif-accent italic font-normal"> Read the shortlist.</span>
          </h1>
