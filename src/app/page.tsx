      ...
      <main>
        <section className="mx-auto max-w-6xl px-6 pb-24 pt-20 md:pb-32 md:pt-28">
          ...
          <h1 className="max-w-3xl text-5xl font-bold leading-[1.05] tracking-tight text-foreground md:text-7xl">
            ...
            <br />
            behind your{" "}
            <span className="serif-accent font-normal">idea.</span>
          </h1>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            <Link
              href="/discover"
              className="bg-primary px-6 py-3 text-sm font-medium tracking-wide text-background transition-colors hover:bg-primary-hover"
            >
              Find APIs
            </Link>
            <Link
              href="/#product"
              className="px-2 py-3 text-sm text-secondary transition-colors hover:text-foreground"
            >
              What AVIEN is →
            </Link>
          </div>
        ...
        <section id="problem" className="border-y border-border bg-surface">
          <div className="mx-auto max-w-6xl px-6 py-24">
            ...
            <h2 className="mt-4 max-w-2xl text-3xl font-semibold tracking-tight md:text-4xl">
              ...
              <span className="mt-2 block serif-accent font-normal text-secondary">
            ...
            <div className="mt-16 grid gap-6 md:grid-cols-3">
              {problems.map((item) => (
                <article
                  key={item.n}
                  className="border border-border bg-surface p-7 shadow-[0_8px_30px_rgba(23,23,23,0.04)]"
                >
        ...
        <section id="product" className="mx-auto max-w-6xl px-6 py-24 md:py-32">
          ...
          <div className="mt-4 grid gap-16 md:grid-cols-[1.1fr_0.9fr] md:items-start">
            ...
            <aside className="border border-border bg-surface p-8 shadow-[0_8px_30px_rgba(23,23,23,0.04)]">
        ...
        <section id="features" className="mx-auto max-w-6xl px-6 py-24 md:py-32">
          ...
          <h2 className="mt-4 max-w-xl text-3xl font-semibold tracking-tight md:text-4xl">
            Quiet tools.{" "}
            <span className="serif-accent font-normal">Serious infrastructure.</span>
          </h2>
        ...
        <section className="mx-auto max-w-6xl px-6 py-24 text-center md:py-28">
          <h2 className="text-3xl font-semibold tracking-tight md:text-4xl">
            Stop browsing.{" "}
            <span className="serif-accent font-normal">Start specifying.</span>
          </h2>
          ...
          <Link
            href="/discover"
            className="mt-8 inline-block bg-primary px-6 py-3 text-sm font-medium tracking-wide text-background hover:bg-primary-hover"
          >
            Open Discover
          </Link>
        </section>
